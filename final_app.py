...
loaded_model = joblib.load(open('/Users/taghridyassergomaa/Downloads/best_xgb_model_pipeline.pkl', 'rb'))
...
def main():
    ...
    resting_bp_s = st.number_input('Resting Blood Pressure', min_value=0, max_value=300, step=1)
    ...
    max_heart_rate = st.number_input('Maximum Heart Rate Achieved', min_value=0, max_value=300, step=1)
